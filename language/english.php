...
$LANG_BAN00 = array (
    ...
    'instructions_sfs_not_updated'  => '<br' . XHTML . '><br' . XHTML . '>The Stop Forum Spam (SFS) database has not been updated yet. You can download it manually now.', 
    'instructions_sfs'              => '<br' . XHTML . '><br' . XHTML . '>The last time your Stop Forum Spam (SFS) database was updated, was on: %s
                                        <br' . XHTML . '><br' . XHTML . '>The next time it can be downloaded manually is: %s (current time: %s)',
    'instructions_sfs_auto_on'      => '<br' . XHTML . '><br' . XHTML . '>The next time your Stop Forum Spam (SFS) database will be auto updated is : %s',
    'instructions_sfs_auto_off'     => '<br' . XHTML . '><br' . XHTML . '>Auto downloading for the Stop Forum Spam (SFS) database is currently disabled.',
